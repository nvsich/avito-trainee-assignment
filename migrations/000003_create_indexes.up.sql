...
-- transfers table
create index if not exists transfers_to_employee_from_employee_idx on transfers (to_employee, from_employee);
create index if not exists transfers_from_employee_to_employee_idx on transfers (from_employee, to_employee);